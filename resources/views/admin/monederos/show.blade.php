...
<x-layouts.app :title="'Monedero ' . $monedero->id" :header="'Monedero de ' . $monedero->id" :meta-description="'informacion del monedero ' . $monedero->id">
    ...
    {{-- <a href="{{ route('monederos.edit', $user) }}">Editar</a>
    <a href="{{ route('monederos.index') }}">Volver</a> --}}
    <a class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-sky-500 rounded-lg hover:bg-sky-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        href="{{ route('monederos.edit', $monedero) }}"><svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20"
