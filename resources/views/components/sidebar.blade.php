                ...
                <ul class="pb-2 space-y-2">
                    <li>
                        <a href="{{ route('users.index') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Monedero</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('users.index') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Comercio</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('users.index') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">{{ __('Editar Perfil') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('users.index') }}"
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                sidebar-toggle-item="">Monedero</span>
        ...
        {{-- <div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800"
            ...
            <div id="tooltip-settings" role="tooltip"
                ...
                <div class="tooltip-arrow" data-popper-arrow=""
                    style="position: absolute; left: 0px; transform: translate3d(54.5px, 0px, 0px);"></div>
            </div>
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700"
                ...
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(183.5px, 987px, 0px);"
