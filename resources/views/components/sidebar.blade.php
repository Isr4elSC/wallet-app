                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('transacciones.index') }}"
                            ...
                            <span class="group-hover:text-sky-600 flex-1 ms-3 whitespace-nowrap">Transacciones</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('promociones.index') }}"
                            ...
                            <span class=" group-hover:text-sky-600 flex-1 ms-3 whitespace-nowrap">Promociones</span>
                        </a>
                    </li>
                </ul>
                <ul class="pb-2 space-y-2">
